  ...
  return (
    <section className="hero" aria-label="Novo Som — hero">
      ...
      >
        ...
        >
          Músicas e aulas de guitarra do YouTube, organizadas em um só lugar. Um cantinho meu pra guardar músicas que gosto e as aulas de guitarra que vou montando com o tempo.
        </motion.p>
